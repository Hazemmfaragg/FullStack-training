...
<body class="bg-white">
    ...
    <div class="container mt-5">
        ...
        <h2 class="d-inline">DASH BOARD</h2>
        <?php if ($role === "admin"): ?>

            <button type="button" class="btn btn-dark btn-sm p-1 mb-2">Go to admin panel</button>
            <button type="button" class="btn btn-outline-secondary btn-sm p-1 mb-2">view login logs</button>
            <button type="button" class="btn btn-outline-danger btn-sm p-1 mb-2">view failed login</button>
            <?php else: ?>
        <button type="button" class="btn btn-secondary btn-sm p-1 mb-2">USER Dash board</button>
        <?php endif ?>
