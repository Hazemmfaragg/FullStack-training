<?php
$arr = [["name"=>"Hazem","course" =>"PHP","grade"=>"75%","status"=>"passed"],
    ["name"=>"Aya","course" =>"JS","grade"=>"95%","status"=>"passed"],
    ["name"=>"Kareem","course" =>"MySQL","grade"=>"58%","status"=>"Failed"],
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center "> 
                           ...
                           <div class="mb-3"> <strong>Name:</strong> <?= $info['name'] ?><br></div>
                            ...
                            <div class="mb-3"><strong>Status:</strong> <?= $info['status'] ?></div>
